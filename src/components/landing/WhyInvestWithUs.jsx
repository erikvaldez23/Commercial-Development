...
const cities = [
  { 
    ...
    top: "40%", 
    left: "27%", 
    description: "Our flagship sustainable skyscraper featuring 40% reduced energy consumption",
    stat: "3.2M sq ft",
    yearCompleted: "2023"
  },
  { 
    ...
    top: "52%", 
    left: "47%", 
    description: "Africa's first carbon-negative commercial development with integrated urban farming",
    stat: "1.8M sq ft",
    yearCompleted: "2024"
  },
  { 
    ...
    top: "48%", 
    left: "58%", 
    description: "Desert-adapted complex with innovative water reclamation systems",
    stat: "2.5M sq ft",
    yearCompleted: "2022"
  },
  { 
    ...
    top: "32%", 
    left: "14%", 
    description: "Timber-hybrid construction using sustainably sourced materials",
    stat: "1.5M sq ft",
    yearCompleted: "2023"
  },
  { 
    ...
    top: "56%", 
    left: "72%", 
    description: "Vertical forest integration with 30,000 plants providing natural cooling",
    stat: "2.1M sq ft",
    yearCompleted: "2024"
  },
  { 
    ...
    >
      ...
      >
        ...
        >
          ...
          >
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima officia nisi voluptatibus quo, ipsa, 
  ex deleniti velit sunt at totam officiis 
  doloremque harum dolorem pariatur, necessitatibus amet magni autem nam.
          </Typography>
        </Box>
        ...
        {selectedCity && (
          <Fade in={!!selectedCity} timeout={600}>
            ...
            >
              <Typography variant="h5" fontWeight={600} color="#e2c799" sx={{ mb: 1 }}>
                {selectedCity.name}
              </Typography>
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                <Box>
                  <Typography variant="caption" color="#e2c799">Development Size</Typography>
                  <Typography variant="body1" fontWeight={500} color="#fff">
                    {selectedCity.stat}
                  </Typography>
                </Box>
                <Box>
                  <Typography variant="caption" color="#e2c799">Completed</Typography>
                  <Typography variant="body1" fontWeight={500} color="#fff">
